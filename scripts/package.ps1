...
try {
    ...
    $legacyFixtureDestination = Join-Path $packageRoot "legacy-fixtures\v0.9"
    ...
    New-Item $legacyFixtureDestination -ItemType Directory -Force | Out-Null
    Copy-Item .\schemas\public\v1\*.schema.json $schemaDestination
    Copy-Item .\tests\fixtures\schema\v1\*.json $fixtureDestination
    Copy-Item .\tests\fixtures\legacy\v0.9\*.json $legacyFixtureDestination
